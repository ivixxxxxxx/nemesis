...
#define PROGRAM_NAME "NEMESIS"
#define PROGRAM_CMD_PREFIX "NEMESIS"
...
namespace ProtoGenesys
{
	...
	*/
	...
	static bool bIsSteamVersion = false;
	...
	static std::uintptr_t dwTransitionPlayerStateCall =   0x51DAE8;
	static std::uintptr_t dwGetWorldTagMatrixCall =   0x7D5CAA;
	static std::uintptr_t dwGameTypeSettingsCall =   0x97CC42;
	static std::uintptr_t dwOrbitalVsat = 0x12A0CA4;

	static std::uintptr_t dwSysGetValueException =   0x5EFBB9;
	static std::uintptr_t dwRegisterShaderException =   0x45A8C9;
	static std::uintptr_t dwConnectPathsException1 =   0x53367B;
	static std::uintptr_t dwConnectPathsException2 =   0x488335;
	static std::uintptr_t dwObituaryException =   0x7A40EC;

	static std::uintptr_t dwComError = 0x58FC30;
	static std::uintptr_t dwSysGetValue =   0x5EFBA0;
	static std::uintptr_t dwSysMilliseconds =   0x57EC40;
	static std::uintptr_t dwRegisterShader =   0x734CC0;
	static std::uintptr_t dwPrepFireParams =   0x638120;
	static std::uintptr_t dwPredictPlayerState =   0x5B4F40;
	static std::uintptr_t dwWritePacket =  0x439380;
	static std::uintptr_t dwSetValueForKey =  0x551B00;
	static std::uintptr_t dwGetUsername =   0x4B58D0;
	static std::uintptr_t dwGetClantag = 0x6D2900;
	static std::uintptr_t dwGetXuidstring =  0x491870;
	static std::uintptr_t dwPopOverlayForSteamID =  0x556680;
	static std::uintptr_t dwGetIntPlayerStatInternal =  0x52EE10;
	static std::uintptr_t dwInt64ToString =   0x427820;
	static std::uintptr_t dwBulletHitEvent =  0x5F72B0;
	static std::uintptr_t dwCalcEntityLerpPositions =   0x6B98D0;
	static std::uintptr_t dwInterpolateEntityPosition =   0x7A0C90;
	static std::uintptr_t dwInterpolateEntityAngles =  0x4B1D40;
	static std::uintptr_t dwTransitionPlayerState =   0x6AB990;
	static std::uintptr_t dwSetupWeaponCamoRender =   0x4B5B20;
	static std::uintptr_t dwGetWorldTagMatrix =   0x4FC740;
	static std::uintptr_t dwGameTypeSettings =  0x4F5F70;
	static std::uintptr_t dwGetAddr =   0x4D3A70;
	static std::uintptr_t dwGetPlayerStatus =   0x8C5F30;
	static std::uintptr_t dwIsValidSteamID =   0x60EFC0;
	static std::uintptr_t dwCreateScreenShot =   0x75CBB0;
	static std::uintptr_t dwAtoiCall1 =   0x7D16B8;
	static std::uintptr_t dwAtoiCall2 =   0x7D16C7;
	static std::uintptr_t dwMemcpyCall =  0x45A840;
	static std::uintptr_t dwFriendPersonaNameFromXuid =   0x6286B0;
	static std::uintptr_t dwGetUserSteamIdAsXuid = 0x5C2CD0;
	static std::uintptr_t dwGetUserSteamIdAsXuidCall =  0x924471;
	static std::uintptr_t dwFilterPersonaNameCall =   0x6286FF;
	...
	static std::uintptr_t dwLocalClientIsInGame =  0x402F80;
	static std::uintptr_t dwGetDObj =   0x4DA190;
	static std::uintptr_t dwRegisterTag =   0x5EE820;
	static std::uintptr_t dwGetTagPosition =   0x4A1210;
	static std::uintptr_t dwGetScreenPlacement =  0x6F6AF0;
	static std::uintptr_t dwEntityIsTeammate =  0x4309A0;
	static std::uintptr_t dwGetTeamColor =  0x5C02D0;
	static std::uintptr_t dwGetPlayerViewOrigin =  0x640E80;
	static std::uintptr_t dwEvaluateTrajectory =  0x44CE20;
	static std::uintptr_t dwWeaponIsVehicle =   0x5AE8C0;
	static std::uintptr_t dwWeaponAmmoAvailable =  0x6DF580;
	static std::uintptr_t dwGetAmmoNotInClip =   0x471050;
	static std::uintptr_t dwGetClipSize =   0x5B4410;
	static std::uintptr_t dwGetHeldWeapon =  0x4368E0;
	static std::uintptr_t dwSetZoomState =   0x583950;
	static std::uintptr_t dwWeaponIsAkimbo =   0x52E780;
	static std::uintptr_t dwGetWeaponDef =   0x5225F0;
	static std::uintptr_t dwGetPenetrateType =   0x4AC220;
	static std::uintptr_t dwBulletTrace =   0x7E0A00;
	static std::uintptr_t dwGetWeaponDamageForRange =  0x676160;
	static std::uintptr_t dwGetWeaponHitLocationMultiplier =   0x669830;
	static std::uintptr_t dwGetTraceHitType = 0x6A32F0;
	static std::uintptr_t dwEntityIsDeployedRiotshield =   0x501160;
	static std::uintptr_t dwHasPerk =  0x530C10;
	static std::uintptr_t dwGetSurfacePenetrationDepth =  0x622CE0;
	static std::uintptr_t dwAdvanceTrace =  0x703090;
	static std::uintptr_t dwPenetrationCheck =   0x7E0C00;
	static std::uintptr_t dwLocationalTrace = 0x50B870;
	static std::uintptr_t dwAddReliableCommand = 0x6A1C40;
	static std::uintptr_t dwCbufAddText =  0x5C6F10;
	static std::uintptr_t dwGetSpreadForWeapon =  0x5B0BE0;
	static std::uintptr_t dwHashSeed =  0x6AACC0;
	static std::uintptr_t dwRandomFloat =  0x4947E0;
	static std::uintptr_t dwSeedRandom =  0x556180;
	static std::uintptr_t dwAngleNormalize180 =  0x5FFDA0;
	static std::uintptr_t dwSetFovSensitivityScale =  0x437730;
	static std::uintptr_t dwGetViewmodelWeaponIndex =   0x54A0D0;
	static std::uintptr_t dwWeaponHasPerk =  0x47ED20;
	static std::uintptr_t dwUsingSniperScope =  0x6C5960;
	static std::uintptr_t dwSetUserCmdAimValues =  0x67ACC0;
	static std::uintptr_t dwClampUserCmdAimValues =  0x942B50;
	static std::uintptr_t dwGetLastWeaponForAlt =  0x480290;
	static std::uintptr_t dwSetUserCmdWeapons =  0x518D70;
	static std::uintptr_t dwSetExtraButtons =  0x6994D0;
	static std::uintptr_t dwGetWeaponName =  0x9502B0;
	static std::uintptr_t dwGetPartyData =  0x615150;
	static std::uintptr_t dwGetSessionData =  0x534520;
	static std::uintptr_t dwIsUserRegistered = 0x44D670;
	static std::uintptr_t dwGetPlayerAddr = 0x641180;
	static std::uintptr_t dwGetPlayerXuid =  0x667A00;
	static std::uintptr_t dwGetOurClientNum =  0x629320;
	static std::uintptr_t dwJoinSessionFromXuid =  0x43D980;
	static std::uintptr_t dwCycleWeapon =  0x57D850;
	static std::uintptr_t dwFindVar =  0x563A70;
	static std::uintptr_t dwFindHash =  0xA5E1D0;
	static std::uintptr_t dwHashMemory =  0xA61B10;
	static std::uintptr_t dwRegisterPrng =  0xA61F20;
	static std::uintptr_t dwFindPrng =  0xA61EB0;
	static std::uintptr_t dwSignHash =  0xA61C10;

	static std::uintptr_t dwTigerHash =  0xC273A4;
	static std::uintptr_t dwPrng =  0xCC8090;
	static std::uintptr_t dwSprng = 0xBD590C;
	static std::uintptr_t dwKey =  0x2FFDB88;

	static std::uintptr_t dwRankXP =  0x2F9076C;
	static std::uintptr_t dwPLevel =  0x2F90754;

	static std::uintptr_t dwStatsBase =  0x2EDF000;
	static std::uintptr_t dwMemoryBase =  0x247F000;

	static std::uintptr_t dwSwapChain =  0x35E5F94;
	static std::uintptr_t dwDevice =  0x35AE484;
	static std::uintptr_t dwDeviceContext =  0x35AE488;
	...
	static std::uintptr_t dwTacSSHandle =  0x3A248F4;
	static std::uintptr_t dwXnAddr =   0x34179B0;
	/*
	//=====================================================================================
	*/
