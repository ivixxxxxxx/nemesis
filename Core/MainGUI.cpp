	...
	*/
	...
	/*	ImGui::GetWindowDrawList()->AddText(Eurostile_Extended, flEurostile_Extended,
		...
		if (bShowWindow)
		{
			...
			ImVec2 tabsize = { 82.0f, 25.0f };
			if (ImGui::TabLabels(_profiler.gMenuTabs->Domain.iMax, acut::StringVectorToCharPointerArray(_profiler.gMenuTabs->szItems), _profiler.gMenuTabs->Current.iValue, NULL, false, NULL, NULL, false, false, NULL, NULL, &tabsize))
			{
				bWriteLog = true;
			}
